package com.cyc.xiangwei.servicr.controller;
...
public class OssServiceController {
    ...
    String bucket = "cycliving-2026";
    String region = "cn-shenzhen";
    String host = "https://cycliving-2026.oss-cn-shenzhen.aliyuncs.com";
...
//        System.out.println(System.getenv("OSS_ACCESS_KEY_ID"));
    ...
    public static AssumeRoleResponseBody.AssumeRoleResponseBodyCredentials getCredential() throws Exception {
        com.aliyun.sts20150401.Client client = OssServiceController.createStsClient();
    ...
    public Result<?> getPostSignatureForOssUpload() throws Exception {
        ...
        String signature = org.apache.commons.codec.binary.Hex.encodeHexString(result);
